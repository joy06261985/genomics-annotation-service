...
class Config(object):
    ...
    # Stripe
    STRIPE_PUBLIC_KEY = "pk_test_51OoBT1JQVNcwFJIUzatT80D5MYe9Nnlwn1t4rK4lapb0Iy3eV9m9EcfH5Hb5c4tNqZbrN9FdOuWyuTcGYFYEVdsR00I8BxS0cy"
    STRIPE_SECRET_KEY = "sk_test_51OoBT1JQVNcwFJIUV7MPttS3DpP1VxgjvDP6QwWK5Yp6GwQVG97q3ODcEsJ8pOHeqauUhjfafCYXX5MP4TrkJwsY00XApRfNYl"
    STRIPE_PRICE_ID = "price_1OoBVxJQVNcwFJIU58M1iXgj"
    ...
    # a16 new edited
    AWS_SNS_JOB_REQUEST_TOPIC_THAW = (
        f"arn:aws:sns:us-east-1:127134666975:{iam_username}_a16_job_thaw" 
    )
    # AWS SQS queues
    AWS_SQS_REQUESTS_QUEUE_NAME = f"https://sqs.us-east-1.amazonaws.com/127134666975/{iam_username}_a16_job_requests"
