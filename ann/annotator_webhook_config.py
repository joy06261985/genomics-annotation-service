...
class Ann_Config(object):

    CSRF_ENABLED = True

    ANNOTATOR_BASE_DIR = "/home/ubuntu/gas/ann"
    ANNOTATOR_JOBS_DIR = f"{ANNOTATOR_BASE_DIR}/outputs"
    ...
    AWS_SQS_URL="https://sqs.us-east-1.amazonaws.com/127134666975/chenhui1_a14_job_requests"
